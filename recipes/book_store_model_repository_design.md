...
INSERT INTO book (title, author_name) VALUES ('Nineteen Eighty-Four', 'George Orwell');
INSERT INTO book (title, author_name) VALUES ('Mrs Dalloway', 'Virginia Woolf');
```
...
class BookRepository
  ...
  def all
    ...
    # SELECT id, title, authoe_name FROM books;
